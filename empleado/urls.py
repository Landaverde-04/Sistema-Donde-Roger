...
urlpatterns = [
    ...
    path('empleado_lista_deshabilitados/', views.empleado_lista_deshabilitados, name='empleado_lista_deshabilitados'),
    path('habilitar_empleado/<str:idEmpleado>/', views.habilitar_empleado, name='habilitar_empleado')
]
