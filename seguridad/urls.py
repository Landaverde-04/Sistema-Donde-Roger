...
urlpatterns = [
    ...
    path('usuario_lista_deshabilitados/', views.usuario_lista_deshabilitados_view, name='usuario_lista_deshabilitados'),
    path('habilitar_usuario/<int:usuario_id>/', views.habilitar_usuario_view, name='habilitar_usuario'),
